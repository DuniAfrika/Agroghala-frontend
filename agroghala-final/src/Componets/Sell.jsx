    ...
    <>
      <div class="bg-white">
        {selectedSoko ? (
          <div class="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-0">
            <div class="relative isolate overflow-hidden bg-green-700 px-24 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
              ...
              <div class="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
                ...
                <p class="mt-6 text-lg leading-8 text-gray-300">Current Price : {selectedSoko.current_price}</p>
                <p class="mt-6 text-lg leading-8 text-gray-300">Last Price : {selectedSoko.last_price}</p>
                <div class="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
                  <a href="#" class="rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-gray-900 
                    shadow-sm hover:bg-gray-100 focus-visible:outline rent-buttons
                    focus-visible:outline-2 focus-visible:outline-offset-2 
                    focus-visible:outline-white" onClick={handleSellButtonClick}>Sell</a>
                  <a href="#" class="text-sm font-semibold leading-6 text-white">Sokos <span aria-hidden="true">→</span></a>
                </div>
              </div>
              <div class="relative mt-16 h-80 lg:mt-8">
                <img class="absolute left-0 top-0 w-[57rem] max-w-none rounded-md bg-white/5 ring-1 ring-white/10" src={Fruit} alt="App screenshot" width="1824" height="1080" />
            </div>
            </div>
          </div>
        ) : null}
            ...
            >
              <>
                ...
                <div class="p-3">
                  ...
                  <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Last Price : {item.last_price}</p>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="hover:border-white shadow p-8 rounded-md">
