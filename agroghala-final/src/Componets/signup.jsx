    ...
    <div className="d-flex justify-content-center align-items-center vh-100 m-5 contain">
      <div className="card shadow-lg px-3 my-5 bg-white rounded row">
          <div className="card-body">
              <h2 className='mt-4'>AGROGHALA</h2>
              <legend className='font-verdana text-center bb-2 p-3 border-bottom'>Sign up</legend>
            ...
            <p className='text-muted py-3 text-center border-top'>Register with</p>
            ...
            <p className='text-center pb-3'>
              Already have an account? <a className="text-success" href={<Login />}>Log in</a>
            </p>
